...
function useStyles() {
  ...
  return useMemo(() => StyleSheet.create({
    ...
    title: { ...(fonts.titleLg as object), color: colors.jet },
    body: { ...(fonts.bodyMd as object), color: colors.slateBrand },
    cancelBtn: { borderRadius: 14, overflow: 'hidden' },
    btnGradient: { height: 48, alignItems: 'center', justifyContent: 'center' },
    cancelLabel: { ...(fonts.titleSm as object), color: '#ffffff' },
    proceedBtn: {
      height: 48,
      borderRadius: 14,
    ...
    proceedLabel: { ...(fonts.titleSm as object), color: colors.red },
  }), [colors])
}
